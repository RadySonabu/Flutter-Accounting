...
class JournalEntryTransactionTypeCreateForm extends StatelessWidget {
  const JournalEntryTransactionTypeCreateForm({Key key}) : super(key: key);
    ...
    return Container(
      ...
      child: ReactiveForm(
          ...
          child: Column(
            children: <Widget>[
              Text(
                'Create Journal Entry Transaction Type',
                style: TextStyle(
                  color: Colors.black,
                  fontSize: 30,
                ),
