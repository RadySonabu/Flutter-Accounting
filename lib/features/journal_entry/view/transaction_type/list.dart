...
class JournalTransactionTypeListPage extends StatelessWidget {
  JournalTransactionTypeListPage({Key key}) : super(key: key);
                  ...
                  if (controller.isLoading.value) {
                    ...
                    return ListTile(
                      ...
                      subtitle: Column(
                        ...
                        children: [
                          Text(
                              'Deduction: ${controller.list[index].name.toString()} '),
                          Text(
                              'ORIGIN: ${controller.list[index].modifiedBy.toString()} '),
                        ],
                      ),
